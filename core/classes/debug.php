...
{
    /**
     * Dumps information about multiple variabels
     *
     */
    ...
    public static function dump($variable, $caption = null)
    {
        ...
        foreach ($maps as $function => $pattern) {
            $output = preg_replace_callback($pattern, ['self', '_process' . ucfirst($function)], $output);
        }
    ...
    private static function _processString(array $matches)
    {
        ...
        return '<span style="color: #0000FF;">string</span>(<span style="color: #1287DB;">'
                . $matches['length'] . ')</span>'
                . '<span style="color: #6B6E6E;">'
                . $matches['value'] . '</span>';
    }
    ...
    {
        return '<span style="color: #0000FF;">bool</span>(<span style="color: #0000FF;">'
                . $matches['value'] . '</span>)';
    }
    ...
    {
        return '<span style="color: #0000FF;">float</span>(<span style="color: #1287DB;">'
                . $matches['value'] . '</span>)';
    }
    ...
    {
        return '<span style="color: #0000FF;">resource</span>(<span style="color: #1287DB;">'
                . $matches['count'] . '</span>) of type (<span style="color: #4D5D94;">'
                . $matches['class'] . '</span>)';
    }
    ...
    {
        return '<span style="color: #0000FF;">object</span>(<span style="color: #4D5D94;">'
                . $matches['class'] . '</span>)#' . $matches['id']
                . ' (<span style="color: #1287DB;">' . $matches['count'] . '</span>)';
    }
